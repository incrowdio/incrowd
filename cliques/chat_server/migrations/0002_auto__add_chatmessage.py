...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'chat_server_chatmessage', (
        ...
        db.send_create_signal(u'chat_server', ['ChatMessage'])


    def backwards(self, orm):
        # Deleting model 'ChatMessage'
        db.delete_table(u'chat_server_chatmessage')
    ...
    models = {
        ...
        u'chat_server.chatuser': {
            'Meta': {'object_name': 'ChatUser'},
            'connected_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
