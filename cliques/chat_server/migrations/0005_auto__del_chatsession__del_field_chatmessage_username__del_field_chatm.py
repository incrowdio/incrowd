...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChatMessage.user'
        db.add_column(u'chat_server_chatmessage', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['website.UserProfile']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'chat_server_chatsession', (
            ...
            ('last_update', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True, db_index=True)),
            ...
            ('session_key', self.gf('django.db.models.fields.CharField')(default='BF86A7EA4014ED12438AB57842B87CE4A7EC3DAC054CCA0F685AD8BDE9AF0198', max_length=255, unique=True, db_index=True)),
