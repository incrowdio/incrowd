...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChatMessage.username'
        db.add_column(u'chat_server_chatmessage', 'username',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChatMessage.username'
        db.delete_column(u'chat_server_chatmessage', 'username')
    ...
    models = {
        ...
        u'chat_server.chatmessage': {
            'Meta': {'ordering': "['-sent']", 'object_name': 'ChatMessage'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'username': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        u'chat_server.chatsession': {
            ...
            'session_key': ('django.db.models.fields.CharField', [], {'default': "'BF86A7EA4014ED12438AB57842B87CE4A7EC3DAC054CCA0F685AD8BDE9AF0198'", 'unique': 'True', 'max_length': '255', 'db_index': 'True'}),
