...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'website_category', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.UserProfile'])),
        ...
        db.add_column(u'website_post', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['website.Category']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserProfile.profile_pic'
        db.alter_column(u'website_userprofile', 'profile_pic', self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100))
        # Deleting field 'Post.category'
        db.delete_column(u'website_post', 'category_id')
    ...
    models = {
        ...
        u'website.userprofile': {
            ...
            'email_settings': ('django.db.models.fields.CharField', [], {'default': "'no'", 'max_length': '64'}),
