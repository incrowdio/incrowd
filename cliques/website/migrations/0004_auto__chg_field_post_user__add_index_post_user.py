...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Post.user' to match new field type.
        db.rename_column(u'website_post', 'user', 'user_id')
        # Changing field 'Post.user'
        db.alter_column(u'website_post', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.UserProfile']))
        # Adding index on 'Post', fields ['user']
        db.create_index(u'website_post', ['user_id'])


    def backwards(self, orm):
        # Removing index on 'Post', fields ['user']
        db.delete_index(u'website_post', ['user_id'])


        # Renaming column for 'Post.user' to match new field type.
        db.rename_column(u'website_post', 'user_id', 'user')
        # Changing field 'Post.user'
        db.alter_column(u'website_post', 'user', self.gf('django.db.models.fields.CharField')(max_length=255))
