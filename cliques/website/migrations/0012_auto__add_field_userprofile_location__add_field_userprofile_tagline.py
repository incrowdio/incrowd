...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'website_userprofile', 'location',
        ...
        db.add_column(u'website_userprofile', 'tagline',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'website_userprofile', 'location')

        # Deleting field 'UserProfile.tagline'
        db.delete_column(u'website_userprofile', 'tagline')
