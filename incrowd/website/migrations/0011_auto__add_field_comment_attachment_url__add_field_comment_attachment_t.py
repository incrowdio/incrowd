...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.attachment_url'
        db.add_column(u'website_comment', 'attachment_url',
                      self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Comment.attachment_type'
        db.add_column(u'website_comment', 'attachment_type',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.attachment_url'
        db.delete_column(u'website_comment', 'attachment_url')

        # Deleting field 'Comment.attachment_type'
        db.delete_column(u'website_comment', 'attachment_type')
