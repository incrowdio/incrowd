...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.poll_votes'
        db.add_column(u'website_userprofile', 'poll_votes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.poll_votes'
        db.delete_column(u'website_userprofile', 'poll_votes')
