...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.fantasy_team_url'
        db.add_column(u'website_userprofile', 'fantasy_team_url',
                      self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.fantasy_team_url'
        db.delete_column(u'website_userprofile', 'fantasy_team_url')
    ...
    models = {
        ...
        u'website.userprofile': {
            ...
            'profile_pic': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
