...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'website_userprofile', 'email_settings',
                      self.gf('django.db.models.fields.CharField')(default='no', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.email_settings'
        db.delete_column(u'website_userprofile', 'email_settings')
