...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Notification.method'
        db.delete_column(u'notify_notification', 'method')


    def backwards(self, orm):
        # Adding field 'Notification.method'
        db.add_column(u'notify_notification', 'method',
