...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'poll_submission', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='user_submissions', to=orm['website.UserProfile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.user'
        db.delete_column(u'poll_submission', 'user_id')
