 ...
 * By Daryl Rowland
 * Modified from: https://github.com/darylrowland/angucomplete
 */

angular.module('autocomplete', [] )
    .directive('autocomplete', function ($parse, $http, $sce, $timeout, BACKEND_SERVER) {
    return {
        restrict: 'EA',
        scope: {
            "id": "@id",
